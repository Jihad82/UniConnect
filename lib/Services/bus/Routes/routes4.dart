...
class Route4Page extends StatefulWidget {
  const Route4Page({super.key});

  @override
  _Route4PageState createState() => _Route4PageState();
}

class _Route4PageState extends State<Route4Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route5').get();
      ...
      final File file = File('${tempDir.path}/route5.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route5.pdf';
