...
class Route6Page extends StatefulWidget {
  const Route6Page({super.key});

  @override
  _Route6PageState createState() => _Route6PageState();
}

class _Route6PageState extends State<Route6Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route7').get();
      ...
      final File file = File('${tempDir.path}/route7.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route7.pdf';
