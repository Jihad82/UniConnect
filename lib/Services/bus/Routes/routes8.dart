...
class Route8Page extends StatefulWidget {
  const Route8Page({super.key});

  @override
  _Route8PageState createState() => _Route8PageState();
}

class _Route8PageState extends State<Route8Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route9').get();
      ...
      final File file = File('${tempDir.path}/route9.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route9.pdf';
