...
class Route9Page extends StatefulWidget {
  const Route9Page({super.key});

  @override
  _Route9PageState createState() => _Route9PageState();
}

class _Route9PageState extends State<Route9Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route10').get();
      ...
      final File file = File('${tempDir.path}/route10.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route10.pdf';
