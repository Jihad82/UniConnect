...
class Route12Page extends StatefulWidget {
  const Route12Page({super.key});

  @override
  _Route12PageState createState() => _Route12PageState();
}

class _Route12PageState extends State<Route12Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route13').get();
      ...
      final File file = File('${tempDir.path}/route13.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route13.pdf';
