...
class Route7Page extends StatefulWidget {
  const Route7Page({super.key});

  @override
  _Route7PageState createState() => _Route7PageState();
}

class _Route7PageState extends State<Route7Page> {
  String localPath = "";
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('bus_pdfs').doc('route8').get();
      ...
      final File file = File('${tempDir.path}/route8.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/route8.pdf';
