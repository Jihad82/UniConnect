...
class ExamBusSchedulePage extends StatelessWidget {
  final List<Map<String, String>> routes = [
    {"routeName": "Route-All", "routeDetails": "Exam Bus Schedule", "pickupTime": "7:00 AM"},

  ];

  ExamBusSchedulePage({super.key});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: TextButton(
          onPressed: () {
            Get.toNamed('/examBusRoutes$routeIndex');
          },
          child: const Row(
