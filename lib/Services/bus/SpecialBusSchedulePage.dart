...
class SpecialBusSchedulePage extends StatelessWidget {
  final List<Map<String, String>> routes = [
    {"routeName": "Route-All", "routeDetails": "Special Bus Schedule", "pickupTime": "7:00 AM"},

  ];

  SpecialBusSchedulePage({super.key});
  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: TextButton(
          onPressed: () {
            Get.toNamed('/specialBusRoutes$routeIndex');
          },
          child: const Row(
