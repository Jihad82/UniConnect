...
class _AcademicCalendarState extends State<AcademicCalendar> {
  ...
  Future<void> _preparePdf() async {
    try {
      ...
      DocumentSnapshot snapshot = await FirebaseFirestore.instance.collection('academic_calendar').doc('calendar').get();
      ...
      if (pdfData != null) {
        ...
        final File file = File('${tempDir.path}/calendar.pdf');
  ...
  Future<void> _downloadPdf() async {
    if (await Permission.storage.request().isGranted) {
      ...
      if (selectedDirectory != null) {
        final String newPath = '$selectedDirectory/calendar.pdf';
