...
class BbaPages extends StatefulWidget {
  const BbaPages({Key? key}) : super(key: key);

  @override
  _BbaPagesState createState() => _BbaPagesState();
}

class _BbaPagesState extends State<BbaPages> {
  ...
  Future<void> loadDataFromJson() async {
    ...
    String jsonString = await rootBundle.loadString('assets/Data/BBA_Faculty_Data.json');
    setState(() {
      data = jsonDecode(jsonString)['BBA_faculty_members'];
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(
        title: 'Dept. of Textile Engineering',
        showBackArrow: true,
        actionWidgets: [],
      ),
