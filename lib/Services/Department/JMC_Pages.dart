...
class JMCPages extends StatefulWidget {
  const JMCPages({Key? key}) : super(key: key);

  @override
  _JMCPagesState createState() => _JMCPagesState();
}

class _JMCPagesState extends State<JMCPages> {
  ...
  Future<void> loadDataFromJson() async {
    ...
    String jsonString = await rootBundle.loadString('assets/Data/JMC_Faculty_Data.json');
    setState(() {
      data = jsonDecode(jsonString)['JMC_faculty_members'];
    });
  }
