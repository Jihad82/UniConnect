...
class TexPages extends StatefulWidget {
  const TexPages({Key? key}) : super(key: key);

  @override
  _TexPagesState createState() => _TexPagesState();
}

class _TexPagesState extends State<TexPages> {
  ...
  Future<void> loadDataFromJson() async {
    ...
    String jsonString = await rootBundle.loadString('assets/Data/TEX_Faculty_Data.json');
    setState(() {
      data = jsonDecode(jsonString)['TEX_faculty_members'];
    });
  }
