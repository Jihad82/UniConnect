...
class CSEpages extends StatefulWidget {
  const CSEpages({Key? key}) : super(key: key);

  @override
  _CSEpagesState createState() => _CSEpagesState();
}

class _CSEpagesState extends State<CSEpages> {
  ...
  Future<void> loadDataFromJson() async {
    ...
    String jsonString = await rootBundle.loadString('assets/Data/CSE_Faculty_Data.json');
    setState(() {
      data = jsonDecode(jsonString)['Cse_faculty_members'];
    });
  }
