...
class LawPages extends StatefulWidget {
  const LawPages({Key? key}) : super(key: key);
...
class _LawPagesState extends State<LawPages> {
  ...
  Future<void> loadDataFromJson() async {
    ...
    String jsonString = await rootBundle.loadString('assets/Data/LAW_Faculty_Data.json');
    setState(() {
      data = jsonDecode(jsonString)['LAW_faculty_members'];
    });
  }
